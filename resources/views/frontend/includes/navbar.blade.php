<header class="header header--organic" data-sticky="true">
        <div class="header__top">
            <div class="container">
                <div class="header__left">
                    ...
                    </div><a class="ps-logo" href="{{ route('homepage') }}"><img src="{{ asset('frontend/img/logo-organic.png') }}" alt=""></a>
                </div>
    ...
    <header class="header header--mobile organic" data-sticky="true">
        ...
        <div class="navigation--mobile">
            <div class="navigation__left"><a class="ps-logo" href="index.html"><img src="img/logo-organic.png" alt=""></a></div>
            <div class="navigation__right">
