...
<div class="ps-home-banner">
            <div class="ps-carousel--nav-inside owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut">
                <div class="ps-banner--organic" data-background="img/slider/home-9/1.jpg"><img src="{{ asset('frontend/img/slider/home-9/1.jpg') }}" alt="">
                ...
                <div class="ps-banner--organic" data-background="img/slider/home-9/2.jpg"><img src="{{ asset('frontend/img/slider/home-9/2.jpg') }}" alt="">
                    <div class="ps-banner__content">
                        <h4>Weekend Promotions</h4>
                ...
                <div class="row">
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="ps-block--category" data-mh="categories">
                            <div class="ps-block__thumbnail"><img src="{{ asset('frontend/img/categories/organic/1.jpg') }}" alt=""></div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="ps-block--category" data-mh="categories">
                            <div class="ps-block__thumbnail"><img src="{{ asset('frontend/img/categories/organic/2.jpg') }}" alt=""></div>
                            <div class="ps-block__content">
                                <p>Fruits</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="ps-block--category" data-mh="categories">
                            <div class="ps-block__thumbnail"><img src="{{ asset('frontend/img/categories/organic/3.jpg') }}" alt=""></div>
                            <div class="ps-block__content">
                                <p>Vegetables</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="ps-block--category" data-mh="categories">
                            <div class="ps-block__thumbnail"><img src="{{ asset('frontend/img/categories/organic/4.jpg') }}" alt=""></div>
                            <div class="ps-block__content">
                                <p>Ocean Foods</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="ps-block--category" data-mh="categories">
                            <div class="ps-block__thumbnail"><img src="{{ asset('frontend/img/categories/organic/5.jpg') }}" alt=""></div>
                            <div class="ps-block__content">
                                <p>Butters &amp; Eggs</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12 ">
                        <div class="ps-block--category" data-mh="categories">
                            <div class="ps-block__thumbnail"><img src="{{ asset('frontend/img/categories/organic/6.jpg') }}" alt=""></div>
                            <div class="ps-block__content">
                                <p>Fresh Meats</p>
                            </div>
                        </div>
        ...
        <div class="ps-home-promotion">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 "><a class="ps-collection" href="#"><img src="{{ asset('frontend/img/promotions/home-9/1.jpg') }}" alt=""></a>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 "><a class="ps-collection" href="#"><img src="{{ asset('frontend/img/promotions/home-9/2.jpg') }}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
                                                ...
                                                <figure>
                                                    <div class="ps-wrapper">
                                                        <div class="ps-product__gallery" data-arrow="true">
                                                            <div class="item"><a href="img/products/home-9/a-1.jpg"><img src="{{ asset('frontend/img/products/home-9/a-1.jpg') }}" alt=""></a></div>
                                                            <div class="item"><a href="img/products/home-9/a-2.jpg"><img src="{{ asset('frontend/img/products/home-9/a-2.jpg') }}" alt=""></a></div>
                                                            <div class="item"><a href="img/products/home-9/a-3.jpg"><img src="{{ asset('frontend/img/products/home-9/a-3.jpg') }}" alt=""></a></div>
                                                        </div>
                                                    </div>
                                                </figure>
                                                <div class="ps-product__variants" data-item="4" data-md="3" data-sm="3" data-arrow="false">
                                                    <div class="item"><img src="{{ asset('frontend/img/products/home-9/a-1.jpg') }}" alt=""></div>
                                                    <div class="item"><img src="{{ asset('frontend/img/products/home-9/a-2.jpg') }}" alt=""></div>
                                                    <div class="item"><img src="{{ asset('frontend/img/products/home-9/a-3.jpg') }}" alt=""></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="ps-product__header">
                                            <div class="ps-product__thumbnail" data-vertical="true">
                                                <figure>
                                                    <div class="ps-wrapper">
                                                        <div class="ps-product__gallery" data-arrow="true">
                                                            <div class="item"><a href="img/products/home-9/b-1.jpg"><img src="{{ asset('frontend/img/products/home-9/b-1.jpg') }}" alt=""></a></div>
                                                            <div class="item"><a href="img/products/home-9/b-2.jpg"><img src="{{ asset('frontend/img/products/home-9/b-2.jpg') }}" alt=""></a></div>
                                                            <div class="item"><a href="img/products/home-9/b-3.jpg"><img src="{{ asset('frontend/img/products/home-9/b-3.jpg') }}" alt=""></a></div>
                                                            <div class="item"><a href="img/products/home-9/b-4.jpg"><img src="{{ asset('frontend/img/products/home-9/b-4.jpg') }}" alt=""></a></div>
                                                        </div>
                                                        <div class="ps-product__badge"><span>Save <br> $9.000</span></div>
                                                    </div>
                                                </figure>
                                                <div class="ps-product__variants" data-item="4" data-md="3" data-sm="3" data-arrow="false">
                                                    <div class="item"><img src="{{ asset('frontend/img/products/home-9/b-1.jpg') }}" alt=""></div>
                                                    <div class="item"><img src="{{ asset('frontend/img/products/home-9/b-2.jpg') }}" alt=""></div>
                                                    <div class="item"><img src="{{ asset('frontend/img/products/home-9/b-3.jpg') }}" alt=""></div>
                                                    <div class="item"><img src="{{ asset('frontend/img/products/home-9/b-4.jpg') }}" alt=""></div>
                                                </div>
                                            </div>
                                            <div class="ps-product__info">
                                                <h5>Investor</h5>
                                ...
                                <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="false" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on">
                                    <div class="ps-product-group">
                                        <div class="ps-product--horizontal">
                                            <div class="ps-product__thumbnail"><a href="product-default.html"><img src="img/products/home-2/recommend/1.jpg" alt=""></a></div>
                                        ...
                                        <div class="ps-product--horizontal">
                                            <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/home-2/recommend/2.jpg') }}" alt=""></a></div>
                                        ...
                                        <div class="ps-product--horizontal">
                                            <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/home-2/recommend/3.jpg') }}" alt=""></a></div>
                                        ...
                                        <div class="ps-product--horizontal">
                                            <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/home-2/recommend/4.jpg') }}" alt=""></a></div>
                                            <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Anderson Composites – Custom Hood</a>
                                                <div class="ps-product__rating">
                                                    <select class="ps-rating" data-read-only="true">
                                                        <option value="1">1</option>
                                    ...
                                    <div class="ps-product-group">
                                        ...
                                        <div class="ps-product--horizontal">
                                            <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/home-2/recommend/5.jpg') }}" alt=""></a></div>
                                        ...
                                        <div class="ps-product--horizontal">
                                            <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/home-2/recommend/6.jpg') }}" alt=""></a></div>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-product">
                                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/organic/1.jpg') }}" alt=""></a>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-product">
                                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/organic/2.jpg') }}" alt=""></a>
                                    <ul class="ps-product__actions">
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                        <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i class="icon-eye"></i></a></li>
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-product">
                                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/organic/3.jpeg') }}" alt=""></a>
                                    <ul class="ps-product__actions">
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                        <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i class="icon-eye"></i></a></li>
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-product">
                                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/organic/4.jpg') }}" alt=""></a>
                                    <ul class="ps-product__actions">
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                        <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i class="icon-eye"></i></a></li>
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-product">
                                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/organic/5.jpg') }}" alt=""></a>
                                    <ul class="ps-product__actions">
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                        <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i class="icon-eye"></i></a></li>
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-product">
                                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/organic/6.jpg') }}" alt=""></a>
                                    <ul class="ps-product__actions">
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                        <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i class="icon-eye"></i></a></li>
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-product">
                                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/organic/7.jpeg') }}" alt=""></a>
                                    <ul class="ps-product__actions">
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                        <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i class="icon-eye"></i></a></li>
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-product">
                                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/organic/8.jpg') }}" alt=""></a>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-product">
                                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/organic/9.jpg') }}" alt=""></a>
                                    <div class="ps-product__badge">12%</div>
                                    <ul class="ps-product__actions">
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                        <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i class="icon-eye"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
                            <div class="ps-product">
                                <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ asset('frontend/img/products/organic/10.jpg') }}" alt=""></a>
                                    <div class="ps-product__badge">12%</div>
                                    <ul class="ps-product__actions">
                                        <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                        <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i class="icon-eye"></i></a></li>
                ...
                <div class="ps-section__content">
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 ">
                            <div class="ps-post">
                                <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{ asset('frontend/img/blog/organic/1.jpg') }}" alt=""></div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 ">
                            <div class="ps-post">
                                <div class="ps-post__thumbnail">
                                    <div class="ps-post__badge"><i class="icon-volume-high"></i></div><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{ asset('frontend/img/blog/organic/2.jpg') }}" alt="">
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 ">
                            <div class="ps-post">
                                <div class="ps-post__thumbnail">
                                    ...
                                    <div class="ps-post__badge"><i class="icon-volume-high"></i></div><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{ asset('frontend/img/blog/organic/3.jpg') }}" alt="">
                                </div>
